...
public class AdminDashboardController {
     ...
     * Calendar cal = Calendar.getInstance();
     * int month = cal.get(Calendar.MONTH) + 1; // Les mois commencent à 0, donc on
     * ajoute 1
     * 
     ...
     * }
     * 
     * // Méthode pour peupler les graphes avec les données des plats les plus
     * vendus
     * public void populateRevenuPlatChart(Connection connection, Date dateDebut,
     * Date dateFin,
     * BarChart<String, Number> revenuPlatChart, boolean isForMonth) {
     * Admin admin = new Admin();
     * Map<String, Integer> revenuPlats =
     * admin.calculerPlatsLesPlusVendus(connection, dateDebut, dateFin);
     * 
     ...
     * platName = platName.substring(0, 10) + "..."; // Tronquer le nom à 10
     * caractères
     * }
     ...
     * if (isForMonth) {
     * ((Text) node).setRotate(-90); // Rotation de l'étiquette à 90 degrés pour un
     * meilleur
     * // ajustement vertical
     * ((Text) node).setTranslateX(-10); // Déplacer l'étiquette vers la gauche pour
     * un meilleur
     * // alignement
     * } else {
     * ((Text) node).setRotate(90); // Rotation de l'étiquette à -90 degrés pour
     * afficher du haut
     * // vers le bas
     * ((Text) node).setTranslateX(10); // Déplacer l'étiquette vers la droite pour
     * un meilleur
     * // alignement
     * }
     * }
     ...
     * public void populateStackedBarChart(Connection connection, Date dateDebut,
     * Date dateFin,
     * StackedBarChart<String, Number> stackedBarChart) {
     * Map<String, Integer[]> dailyOrders = getDailyOrders(connection, dateDebut,
     * dateFin);
     * 
     ...
     * private Map<String, Integer[]> getDailyOrders(Connection connection, Date
     ...
     * }
     * 
     * private Map<String, Integer[]> getWeeklyOrders(Connection connection, Date
     * dateDebut, Date dateFin) {
     ...
     * // Ici, vous pouvez utiliser SimpleDateFormat ou une autre méthode pour
     * formater
     * // la date selon vos préférences
     * return ""; // Implémentez votre logique de formatage ici
     * }
     * 
     * private Map<String, Integer[]> getMonthlyOrders(Connection connection, Date
     * dateDebut, Date dateFin) {
     ...
     * 
     * // Votre méthode calculerCommandesLivreesEtAnnulees
     * public int[] getCommandesLivreesEtAnnulees(Connection connection, Date
     * dateDebut, Date dateFin) {
     * Admin admin = new Admin();
     * 
     * // Calculer les commandes livrées et annulées pour la période spécifiée
     * Map<String, Integer> commandes =
     * admin.calculerCommandesLivreesEtAnnulees(connection, dateDebut, dateFin);
     * 
